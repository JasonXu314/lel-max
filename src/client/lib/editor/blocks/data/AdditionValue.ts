...
export class AdditionValue extends Value implements IValueHost {
	...
	public constructor() {
		...
		this.shape = new PathBuilder<AdditionValueShapeParams>(
			({ width }) => width,
			({ height }) => height
		)
	...
	public duplicate(): Block[][] {
		...
		const [[that]] = super.duplicate() as [[AdditionValue]];
