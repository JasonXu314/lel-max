...
export class IfBlock extends ChainBranchBlock implements IPredicateHost {
	...
	public get height(): number {
		...
		return 20 + this.condition.height + 6 + (this.affChild === null ? 20 : this.affChild.reduceChain<number>(effectiveHeight, 0) + 20);
	}
	...
	public duplicate(): Block[][] {
		...
		const [[that]] = super.duplicate() as [[IfBlock]];
