...
export class GTPredicate extends Predicate implements IValueHost {
	...
	public constructor() {
		...
		this.shape = new PathBuilder<GTPredicateShapeParams>(
			({ width }) => width,
			({ height }) => height
		)
	...
	public duplicate(): Block[][] {
		...
		const [[that]] = super.duplicate() as [[GTPredicate]];
